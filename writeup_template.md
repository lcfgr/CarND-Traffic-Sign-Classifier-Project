...
[image2]: ./writeup/speed100_orig.png "Example1"
...
####5. The submission describes the approach to finding a solution. Accuracy on the validation should be 0.93 or greater.
...
The code for making predictions on my final model is located in the ** XXXX ** cell of the Ipython notebook.
...
The code for making predictions on my final model is located in the **22** cell of the Ipython notebook.
